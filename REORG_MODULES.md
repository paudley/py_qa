...
- **Tooling spec:** The catalog/tooling_spec packages will be released as an independent project with semver guarantees and first-class documentation for the broader lint tooling ecosystem.
