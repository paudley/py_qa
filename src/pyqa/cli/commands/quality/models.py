...
def _collect_quality_path_args(
    ...
    Args:
        ...
        paths: Optional path list supplied via CLI arguments.
        staged: Flag indicating whether staged files should be targeted.

    Returns:
        _QualityPathArgs: Structured path arguments for quality checks.
    """
...
def _collect_quality_flag_args(
    ...
    Args:
        fix: Flag indicating whether fixes should be attempted.
        check: Optional list of requested check identifiers.
        no_schema: Flag disabling schema validation when ``True``.
        emoji: Flag controlling emoji output in diagnostics.

    Returns:
        _QualityFlagArgs: Structured flag arguments for quality checks.
    """
...
def _collect_quality_cli_params(
    ...
    Args:
        path_args: Structured path arguments collected from Typer dependencies.
        flag_args: Structured flag arguments collected from Typer dependencies.

    Returns:
        QualityCLIInputParams: Combined CLI inputs prior to normalisation.
    """
...
def build_quality_options(
    ...
    Returns:
        QualityCLIOptions: Normalised quality command options.
    """
