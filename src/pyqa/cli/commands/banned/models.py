...
def build_banned_options(
    ...
    Args:
        commit_messages_file: Optional commit messages file supplied via CLI.
        text: Optional text content provided directly on the CLI.
        root: Repository root directory used to resolve relative paths.
        personal_list: Optional personal banned words list path.
        repo_list: Optional repository banned words list path.

    Returns:
        BannedCLIOptions: Structured CLI options for the banned words scanner.
    """
