    ...
    def from_cli(
        ...
        *,
        ...
        Args:
            ...
            hooks_dir: Hooks directory provided via CLI options.
            dry_run: Flag indicating whether to avoid filesystem modifications.
            emoji: Flag controlling emoji usage in CLI output.

        Returns:
            HookCLIOptions: Normalised hook command options.
        """
...
def build_hook_options(
    ...
    Args:
        ...
        hooks_dir: Hooks directory override supplied via CLI options.
        dry_run: Flag indicating whether to avoid filesystem modifications.
        emoji: Flag controlling emoji usage in CLI output.
