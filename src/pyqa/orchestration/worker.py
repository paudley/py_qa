...
from ..core.runtime.process import CommandOptions, CommandOverrideMapping, CommandOverrideValue
...
def run_command(
    ...
    *,
    ...
    override_values: dict[str, CommandOverrideValue] = dict(overrides or {})
