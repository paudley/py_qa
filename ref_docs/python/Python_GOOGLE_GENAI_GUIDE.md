...
To prevent errors from exceeding a model's context window and to accurately forecast costs, it is a best practice to count the number of tokens in a prompt _before_ sending it to the API. The client.count_tokens() method provides this functionality.29
